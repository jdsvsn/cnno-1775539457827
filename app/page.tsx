...
const basePath = '/cnno-1775539457827';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Indulge in our classic cinnamon rolls, carefully crafted with the finest ingredients and a dash of love, perfect for satisfying your sweet tooth. Our OG Rolls are a timeless favorite, sure to become a staple in your household.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'Experience the delightful combination of crunchy pistachios and soft, fluffy dough, perfectly balanced to tease your taste buds. Our Pistachio Rolls are a unique twist on the classic, sure to intrigue your senses.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Treat yourself to a rich, velvety chocolate experience, as our decadent chocolate rolls melt in your mouth, leaving you craving for more. Perfect for chocolate lovers, our Chocolate Rolls are a heavenly delight.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80', icon: 'chair' }, { n: 'Baby Rolls', d: 'Bite into our adorable Baby Rolls, meticulously crafted to provide the perfect snack size, bursting with flavor and texture. These miniature treats are ideal for on-the-go indulgence or as a delightful accompaniment to your daily coffee.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'eco' }, { n: 'Party Box', d: 'Gather your friends and family, and indulge in our Party Box, filled with an assortment of our signature rolls, carefully curated to satisfy a variety of tastes and preferences. Perfect for celebrations, gatherings, or simply because, our Party Box is the ultimate treat to share with loved ones.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'precision_manufacturing' }];
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft artisanal sweet rolls that bring warmth and comfort to our community, one delicious bite at a time.</p>
                </div>
                <div className="space-y-2">
